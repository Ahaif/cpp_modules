...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2022/03/26 11:16:50 by ahaifoul          #+#    #+#             */
/*   Updated: 2022/04/02 11:17:27 by ahaifoul         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
Casts::Casts(const std::string Number) : _Type(0), _IntForm(0), _CharForm(0), _FloatForm(0.0), _DoubleForm(0.0)
{
...
void Casts::FromInt()
{
    ...
    this->_FloatForm = static_cast<float>(this->_IntForm); //remove cast and test
...
std::string Casts::printFloat(std::string Number)
{
    ...
    else
    {
        ...
        if (Number.find(".") == std::string::npos)
        {
            ...
            // std::cout << fs.erase(Number.length() + 2) << std ::endl;
